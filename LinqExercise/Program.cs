...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Employees who's names begin with an S or a C");
            ...
            {
                Console.WriteLine($"Fullname: {person.FullName}  Age: {person.Age}  Years of Experience: {person.YearsOfExperience}");
            }
            ...
            employees = employees.Append(new Employee("Doug", "lastName", 50, 15)).ToList();
